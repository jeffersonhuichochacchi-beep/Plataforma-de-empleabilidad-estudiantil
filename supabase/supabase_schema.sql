...
-- Requisito: crear Auth users desde Supabase Auth; nunca insertar contraseñas en public.
...
-- Vinculación con Supabase Auth. El usuario debe existir previamente en auth.users.
...
-- Los datos de autenticación ya no pertenecen al esquema de la aplicación.
